...
// are live; Meta explorer / Recommendations oversight / Operators are the
// destinations AIC-45/46/47 build — shown as disabled "coming soon" rows until
// then, same pattern Pisga uses for unbuilt sections.
