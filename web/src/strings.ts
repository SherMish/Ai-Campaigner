...
export const strings = {
  he: {
    ...
    ops: {
      ...
      queueSeverityMedium: "בינונית",
      queueSeverityLow: "נמוכה",
    ...
    // Internal organic-marketing carousel generator (AIC-142). This is an
    // ops tool, not part of the customer product. The template samples are
    // real Hebrew copy because an operator should start from something useful,
    // never lorem ipsum — and they still obey the one-strings-file rule.
    contentStudio: {
      title: "סטודיו תוכן",
      subtitle: "בוחרים מבנה, ממלאים את הרעיון ומורידים קרוסלה מוכנה לאינסטגרם.",
      internalOnly: "כלי פנימי · 1080×1350 · עד 10 שקופיות",
      chooseTemplate: "איזה סוג פוסט יוצרים?",
      editContent: "תוכן הקרוסלה",
      jsonTitle: "מילוי מהיר מ־JSON",
      jsonHint: "מדביקים JSON אחד וכל הטקסטים נכנסים אוטומטית לשדות ולשקופיות הנכונים.",
      jsonInputLabel: "JSON למילוי הקרוסלה",
      jsonPlaceholder: "הדביקו כאן את ה־JSON…",
      jsonCopy: "העתקת מבנה JSON",
      jsonImport: "מילוי מה־JSON",
      jsonShowFormat: "הצגת המבנה הנדרש",
      jsonTemplateField: "סוג התבנית",
      jsonImported: "כל הטקסטים מולאו. אפשר לעבור על התצוגה המקדימה.",
      jsonCopied: "מבנה ה־JSON הועתק.",
      jsonCopyError: "לא הצלחנו להעתיק. אפשר לפתוח את המבנה ולהעתיק ידנית.",
      jsonErrors: {
        invalid_json: "ה־JSON לא תקין. בדקו סוגריים, מירכאות ופסיקים.",
        invalid_shape: "צריך להדביק אובייקט JSON אחד לפי המבנה שמופיע כאן.",
        unsupported_template: "סוג התבנית לא נתמך:",
        unknown_fields: "יש ב־JSON שדות שלא קיימים במבנה:",
        missing_fields: "חסרים ערכים בשדות הבאים:",
        non_string_values: "הערכים הבאים חייבים להיות טקסט:",
        too_long: "הטקסט ארוך מדי בשדות הבאים:",
      },
      carouselName: "שם הקובץ",
      carouselNameHint: "משמש רק בשמות קובצי ה־PNG",
      imageTitle: "תמונה לשקופית",
      imageHint: "לא חובה · PNG או JPG · התמונה תיחתך אוטומטית בלי להימתח",
      chooseImage: "בחירת תמונה",
      replaceImage: "החלפת תמונה",
      removeImage: "הסרת תמונה",
      noImageOnCta: "שקופית הסיום משתמשת תמיד בעיצוב המותג.",
      preview: "תצוגה מקדימה",
      previous: "הקודמת",
      next: "הבאה",
      exportCurrent: "הורדת השקופית",
      exportAll: "הורדת כל הקרוסלה",
      exporting: "מכינים PNG…",
      exportReady: "הקבצים ירדו לפי הסדר. אם הדפדפן שאל — יש לאשר הורדות מרובות.",
      exportError: "לא הצלחנו ליצור את קובץ ה־PNG. נסו שוב.",
      validationTitle: "צריך לתקן לפני ההורדה",
      requiredError: "השדה הזה נדרש.",
      tooLongError: "הטקסט ארוך מדי ועלול להיחתך בשקופית.",
      chars: "תווים",
      slide: "שקופית",
      imageReadError: "לא הצלחנו לקרוא את התמונה הזאת.",
      templates: {
        myth: {
          name: "מיתוס מול מציאות",
          shortName: "מיתוס",
          purpose: "מתקנים אמונה נפוצה שגורמת לבעלי עסקים לקבל החלטות פרסום לא טובות.",
          fields: {
            hook: "הוק",
            myth: "המיתוס",
            why: "למה זה נשמע הגיוני",
            truth: "מה קורה בפועל",
            rule: "כלל מעשי",
            ruleBody: "הסבר קצר",
            ctaTitle: "כותרת CTA",
          ...
          defaults: {
            hook: "קמפיין שלא משתנה כל שבוע לא בהכרח תקוע",
            myth: "אם מנהל הקמפיין לא עושה שינויים — הוא לא באמת עובד",
            why: "כשמשלמים על ניהול, טבעי לצפות לראות פעולה. שינוי בתקציב או במודעות נראה כמו הוכחה שמישהו מטפל בקמפיין.",
            truth: "שינוי בלי מספיק נתונים יכול לעצור את הלמידה ולפגוע דווקא במה שעובד. לפעמים ההחלטה המקצועית היא להמשיך לעקוב.",
            rule: "מנהל טוב יודע גם מתי לא לגעת",
            ruleBody: "שינוי צריך להגיע עם סיבה, נתונים ברורים ותוצאה שאפשר לבדוק אחר כך — לא רק כדי להרגיש שנעשתה פעולה.",
            ctaTitle: "רוצים לדעת אם הקמפיין באמת צריך שינוי?",
          ...
          slides: {
            ...
            mythEyebrow: "המיתוס",
            mythAccent: "לא בהכרח",
            whyEyebrow: "למה קל להאמין לזה",
            whyTitle: "פעולה נראית כמו עבודה",
        ...
        signal: {
          name: "ידעתם? סימן שכדאי להכיר",
          shortName: "ידעתם",
          purpose: "הופכים נתון או סימן פרסומי אחד לתובנה פשוטה שאפשר לפעול לפיה.",
          sourceHint: "חובה כשמשתמשים בנתון חיצוני",
          fields: {
            hook: "הוק / נתון מפתיע",
            bigNumber: "מספר או ביטוי מרכזי",
            fact: "המשמעות המפתיעה",
            context: "הקשר",
            example: "דוגמה",
            action: "מה לבדוק עכשיו",
            source: "מקור / הסתייגות",
            ctaTitle: "כותרת CTA",
            ctaBody: "CTA עדין",
          },
          defaults: {
            hook: "עלות נמוכה לפנייה יכולה להיות סימן רע",
            bigNumber: "₪25",
            fact: "לפנייה נשמע מצוין — עד שמגלים שאף אחת מהן לא רלוונטית",
            context: "Meta יודעת מי לחץ או השאיר פרטים. היא לא יודעת מי באמת מתאים לעסק, קבע תור או הפך ללקוח.",
            example: "קמפיין א׳ מביא פנייה ב־₪25, אבל רק אחת מכל עשר רלוונטית. קמפיין ב׳ מביא פנייה ב־₪40, אבל שש מכל עשר רלוונטיות.",
            action: "בדקו לא רק כמה פניות קיבלתם, אלא כמה מהן היו רלוונטיות וכמה הפכו ללקוחות.",
            source: "המספרים בדוגמה להמחשה בלבד",
            ctaTitle: "מחיר לפנייה הוא רק חצי מהסיפור",
        ...
        checklist: {
          name: "צ׳קליסט מעשי",
          shortName: "צ׳קליסט",
          purpose: "נותנים לבעל העסק סדרת בדיקות קצרה לפני החלטה שעולה כסף.",
          fields: {
            hook: "הוק",
            check1Title: "בדיקה 1 — כותרת",
            check1Body: "בדיקה 1 — הסבר",
            check2Title: "בדיקה 2 — כותרת",
            check2Body: "בדיקה 2 — הסבר",
            check3Title: "בדיקה 3 — כותרת",
            check3Body: "בדיקה 3 — הסבר",
            warning: "הטעות הנפוצה",
            ctaTitle: "כותרת CTA",
            ctaBody: "CTA עדין",
          },
          defaults: {
            hook: "לפני שמגדילים תקציב: 3 בדיקות של שתי דקות",
            check1Title: "האם הפניות באמת נספרות?",
            check1Body: "בדקו שהטופס, הפיקסל או כפתור הוואטסאפ עובדים ושמה שאתם רואים ב־Meta תואם למה שנכנס בפועל.",
            check2Title: "האם ההצעה ברורה?",
            check2Body: "הלקוח צריך להבין תוך שניות מה אתם מציעים, למי זה מתאים ולמה כדאי לו לפנות עכשיו.",
            check3Title: "האם יש מה להשוות?",
            check3Body: "עם מודעה אחת אי אפשר לדעת אם הקריאייטיב טוב. רצוי להריץ כמה מודעות שונות תחת אותו יעד.",
            warning: "אם אחת משלוש הבדיקות לא תקינה, עוד תקציב לא יפתור את הבעיה — הוא רק יגדיל אותה מהר יותר.",
            ctaTitle: "לא בטוחים מה עוצר את הקמפיין?",
    ...
    adminUsers: {
      ...
      // AIC-192 — set a user's password.
      password: {
        open: "שינוי סיסמה",
        title: "שינוי סיסמה",
        body: "הסיסמה החדשה תחליף את הקיימת מיד. לא נשלח ללקוח שום עדכון — מסרו לו אותה בעצמכם.",
        newLabel: "סיסמה חדשה",
        ...
        close: "סגירה",
        sessionsNote: "מי שכבר מחובר לחשבון במכשיר אחר יישאר מחובר.",
        errMismatch: "הסיסמאות לא תואמות.",
        errTooShort: "הסיסמה צריכה להכיל לפחות 8 תווים.",
        errTooLong: "הסיסמה ארוכה מדי.",
        errForbidden: "רק מנהל מלא יכול לשנות סיסמה של משתמש.",
        errFailed: "לא הצלחנו לשמור. אפשר לנסות שוב.",
      },
    ...
    onboardingWizard: {
      ...
      // AIC-190 — import every campaign on the account in one go.
      bulk: {
        open: (n: number) => `או לייבא את כל הקמפיינים בחשבון (${n})`,
        title: "ייבוא כל הקמפיינים",
        sub: "כל קמפיין שאפשר לזהות את היעד שלו ייובא. שום דבר לא משתנה ב-Meta — הקמפיינים ממשיכים לרוץ בדיוק כמו עכשיו.",
        whatsappLabel: "מספר וואטסאפ של העסק",
        whatsappHint: "אחד לכל הקמפיינים — זה המספר של העסק, לא של קמפיין.",
        budgetLabel: "תקציב יומי מוסכם (₪) לקמפיינים בלי תקציב קמפיין",
        budgetHint: "קמפיינים ממומנים (Boost) ותקציבים ברמת קבוצת המודעות לא מחזיקים תקציב בקמפיין עצמו. התקרה הזו חלה רק עליהם.",
        refresh: "עדכון התצוגה",
        loading: "קוראים את הקמפיינים מ-Meta…",
        willImport: (n: number) => `ייובאו (${n})`,
        willSkip: (n: number) => `לא ייובאו (${n})`,
        budgetFromMeta: "מ-Meta",
        budgetFromFallback: "התקרה שהזנתם",
        confirm: (n: number) => `ייבוא ${n} קמפיינים`,
        importing: "מייבאים…",
        cancel: "סגירה",
        nothingToImport: "אין כרגע קמפיין שאפשר לייבא. בדקו את הסיבות למטה.",
        resultTitle: "תוצאה",
        outcome: {
          imported: "יובא",
          already_linked: "כבר מחובר — דולג",
          failed: "נכשל",
        },
        skip: {
          no_ad_sets: "אין בו קבוצות מודעות",
          mixed_ad_sets: "קבוצות מודעות עם יעדים שונים",
          unrecognized_objective: "לא הצלחנו לזהות לאן מגיעה הפנייה",
          deleted: "נמחק או הועבר לארכיון ב-Meta",
          no_budget: "אין תקציב קמפיין ב-Meta — הזינו תקרה למעלה",
          missing_whatsapp: "קמפיין וואטסאפ — הזינו מספר וואטסאפ למעלה",
        },
        rateLimited: "Meta מגבילה כרגע את קצב הבקשות לחשבון הזה. מחכים דקה ומנסים שוב.",
        failed: "לא הצלחנו לקרוא את הקמפיינים. אפשר לנסות שוב.",
      },
    ...
    fleet: {
      ...
      // AIC-122: the four analytics blocks.
      trendTitle: "מגמת הוצאה ופניות",
      trendSub: "30 הימים האחרונים, כל הקמפיינים המנוהלים. ימים ללא נתונים מופיעים כרווח — לא כאפס.",
      trendSpend: "הוצאה יומית",
      trendLeads: "פניות ביום",
      trendEmpty: "אין עדיין נתונים יומיים להצגה.",
      automationTitle: "אוטומציה",
      automationSub: "אחוז הפעולות שבוצעו על ידי המנוע, בלי מגע אדם.",
      automationAutomated: "אוטומטי",
      automationHuman: "ידני",
      automationEmpty: "עדיין לא בוצעו פעולות.",
      queueHealthTitle: "בריאות התור",
      queueHealthSub: "פריטים פתוחים לפי חומרה, והסוגים החוזרים ביותר.",
      queueHealthEmpty: "התור ריק — אין פריטים פתוחים.",
      healthTitle: "בריאות התיק",
      healthSub: "מתוך הקמפיינים המנוהלים (לא כולל \'לא מנוהל\').",
      healthDelivery: "פרסום",
      healthTracking: "מדידה",
      healthOk: "תקין",
      healthBroken: "תקול",
      healthEmpty: "אין קמפיינים מנוהלים.",
    },
    ...
    app: {
      ...
      home: {
        ...
        controls: {
          ...
          // AIC-168: זמני, ולא תקלה במוצר. Meta חוסמת לרגע חשבון פרסום שקיבל
          // יותר מדי קריאות; ההנחיה הנכונה היחידה היא לחכות דקה ולנסות שוב.
    ...
    additions: {
      ...
      ctx: {
        ...
        angleNames: {
          ...
          objection: "הסרת חשש",
          local: "מקומיות",
          // Added from a live ad: a provocation plus "there's another way".
          // Its body argued cost, so it used to be filed under price.
          contrarian: "פרובוקציה / יש דרך אחרת",
        } as Record<string, string>,
        ...
        // The reading itself is thin — said plainly rather than letting a
        // confident-looking label stand on one matched word.
        angleWeak: "זיהוי לא ודאי",
      ...
      // AIC-171 — הקהל הזה מפרסם מעמוד פייסבוק אחר, ו-Meta לא מרשה לצרף אליו
      // מודעה שנבנתה מהעמוד המחובר. לא תקלה זמנית: בלי חיבור לאותו עמוד אי
      // אפשר להוסיף לשם תוכן בכלל.
      adSetOtherPage: "הקהל הזה מפרסם מעמוד פייסבוק אחר, שאינו מחובר אלינו — אי אפשר להוסיף אליו מודעות דרכנו. אפשר לבחור קהל אחר, או לחבר את אותו עמוד.",
      adSetPaused: "מושהית",
      adsTitle: "המודעה",
