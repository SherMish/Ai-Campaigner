...
export const strings = {
  he: {
    ...
    app: {
      ...
      onboarding: {
        eyebrow: "סטטוס ההקמה",
        greeting: "שלום לילך, אנחנו מקימים את הניהול",
      ...
      home: {
        ...
        states: {
          ...
          paused: { badge: "מושהה", title: "הקמפיין כרגע מושהה", body: "השהינו את הקמפיין ב־3 באוגוסט לפי הבקשה שלך בשיחה. הוא לא מוציא תקציב ולא מביא פניות עד שנחזיר אותו לפעילות.", cta: "להחזיר לפעילות" },
        ...
        weeklyCount: "קיבלת 12 פניות. כמה מהן היו רלוונטיות?",
