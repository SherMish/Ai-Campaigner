      ...
      templates: {
        ...
        checklist: {
          ...
          fields: {
            ...
            check4Title: "בדיקה 4 — כותרת",
            check4Body: "בדיקה 4 — הסבר",
            warning: "הטעות הנפוצה",
            ctaTitle: "כותרת CTA",
            ctaBody: "CTA עדין",
          },
          defaults: {
            hook: "לפני שמגדילים תקציב: 4 בדיקות של שתי דקות",
            ...
            check4Title: "האם חוזרים מהר לפניות?",
            check4Body: "גם קמפיין מצוין נראה גרוע כשפנייה מחכה שעות. בדקו את זמן התגובה לפני שמאשימים את הפרסום.",
            warning: "אם אחת מארבע הבדיקות לא תקינה, עוד תקציב לא יפתור את הבעיה — הוא רק יגדיל אותה מהר יותר.",
